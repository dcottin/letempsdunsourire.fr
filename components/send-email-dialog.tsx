...
export function SendEmailDialog({
    ...
    const content = (
        <div className="bg-white w-full h-full flex flex-col overflow-hidden">
            ...
            <div className="flex-1 overflow-y-auto px-4 py-4 sm:px-6 sm:py-6 flex flex-col gap-4">
                <Card className="border-indigo-200 shadow-md relative overflow-hidden ring-2 ring-indigo-500/10 shrink-0">
                    <CardContent className="p-3 sm:p-4 space-y-3">
                        {templates && templates.length > 0 && (
                            <div className="grid gap-1">
                                <Label className="text-slate-400 uppercase font-bold tracking-wider text-[10px] sm:text-xs pl-1 sm:pl-0">Modèle</Label>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            <div className="grid gap-1">
                                <div className="flex items-center justify-between h-5">
                                    <Label htmlFor="email" className="text-slate-400 uppercase font-bold tracking-wider text-[10px] sm:text-xs pl-1 sm:pl-0">Destinataire</Label>
                                    {hasRIB && (
                            ...
                            <div className="grid gap-1">
                                <Label htmlFor="subject" className="text-slate-400 uppercase font-bold tracking-wider text-[10px] sm:text-xs pl-1 sm:pl-0">Sujet de l'email</Label>
                                <Input
                                    id="subject"
                                    value={subject}
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="message" className="text-slate-400 uppercase font-bold tracking-wider text-[10px] sm:text-xs pl-1 sm:pl-0">Message</Label>
                            {isIOS ? (
                                <div
